    ...
    public static JoystickInput FromString(string value)
    {
        ...
        if (value.StartsWith("Axis "))
        {
            ...
            try
            {
                ...
                axisNumber = (Convert.ToInt32(value.Substring(0, index)) - 1) * 2;
            ...
            return new JoystickInput((JoystickAxis)axisNumber, threshold, target, modifiers);
            //try
            //{
    ...
    public override string ToString()
    {
        if (mCachedToString == null)
        {
            ...
            if (mAxis != JoystickAxis.None)
            {
                ...
                res += "Axis " + axisId.ToString() + " " + (positive ? "(+) " : "(-) ") + mThreshold.ToString(); ;
